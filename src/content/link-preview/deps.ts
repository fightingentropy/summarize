...
import type { LinkPreviewProfileEvent, LinkPreviewProfileSink } from "./profiling.js";
...
export type { LinkPreviewProfileEvent, LinkPreviewProfileSink } from "./profiling.js";
...
export interface WebsiteScrapeResult {
  ...
  provider?: "firecrawl" | "exa" | "cloudflare";
}

export type ScrapeWebsite = (
  url: string,
...
export interface LinkPreviewDeps {
  ...
  onProfile?: ((event: LinkPreviewProfileEvent) => void) | null;
}
