...
import { getSlidesOcrAvailability } from "../slides/ocr.js";
...
function resolveRequestSlidesSettings({
  ...
  void resolveToolPath;
  const slidesOcrValue = getSlidesOcrAvailability(env).available ? request.slidesOcr : false;
