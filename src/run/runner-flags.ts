...
export type RunnerFlagResolution = {
  ...
  requestedWebsiteScrapeMode: WebsiteScrapeMode;
...
export function resolveRunnerFlags({
  ...
  return {
    ...
    requestedFirecrawlMode: runSettings.websiteScrapeMode,
    requestedWebsiteScrapeMode: runSettings.websiteScrapeMode,
