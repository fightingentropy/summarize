...
export type ResolvedRunSettings = {
  lengthArg: LengthArg;
  websiteScrapeMode: WebsiteScrapeMode;
  firecrawlMode: WebsiteScrapeMode;
...
export type RunOverrides = {
  websiteScrapeMode: WebsiteScrapeMode | null;
  firecrawlMode: WebsiteScrapeMode | null;
...
export function resolveCliRunSettings({
  ...
  return {
    ...
    websiteScrapeMode: requireOverride(strictOverrides.websiteScrapeMode, "--website-scrape"),
    firecrawlMode: requireOverride(strictOverrides.websiteScrapeMode, "--website-scrape"),
...
export function resolveRunOverrides(
  ...
  return {
    websiteScrapeMode: parseOptionalSetting(
      websiteScrape ?? firecrawl,
      parseWebsiteScrapeMode,
      strict,
    ),
    firecrawlMode: parseOptionalSetting(websiteScrape ?? firecrawl, parseWebsiteScrapeMode, strict),
