...
describe("config loading", () => {
  ...
  it("rejects invalid slides config", () => {
    ...
    const { root: badOcrMode } = writeJsonConfig({ slides: { ocrMode: "turbo" } });
    expect(() => loadSummarizeConfig({ env: { HOME: badOcrMode } })).toThrow(/slides\.ocrMode/);
