...
describe("content/url", () => {
  ...
  it("canonicalizes YouTube video URLs to a stable watch URL", () => {
    expect(canonicalizeYouTubeVideoUrl("https://youtu.be/dQw4w9WgXcQ?t=43")).toBe(
      "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    );
    expect(canonicalizeYouTubeVideoUrl("https://www.youtube.com/live/dQw4w9WgXcQ")).toBe(
      "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    );
  });
