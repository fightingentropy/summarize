...
```bash
npx -y summarize "https://example.com"
```
...
```bash
npm i summarize-core
```

```ts
import { createLinkPreviewClient } from "summarize-core/content";
```
...
- `summarize-core/content`
- `summarize-core/prompts`
