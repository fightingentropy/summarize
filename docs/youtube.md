...
```bash
bun run summarize -- --extract "https://www.youtube.com/watch?v=I845O57ZSy4&t=11s"
```
...
Published macOS builds bundle the Vision OCR helper; source/dev builds may need Xcode Command Line Tools.
On Apple Silicon, slides OCR defaults to Vision's faster recognition mode.
